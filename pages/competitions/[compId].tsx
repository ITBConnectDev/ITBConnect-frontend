  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="relative w-full mb-32">
        <div className="w-full max-w-screen-lg mx-auto lg:px-32 xl:px-0">
          <Image
            src={Index3}
            alt="decor"
          ...
          <div className="w-full">
            ...
            <div className="flex justify-center mt-3">
              <button className="bg-blue-primary text-white text-xs sm:text-sm w-48 py-4 sm:py-5 rounded-md mt-8 md:mt-0">
                SHARE
              </button>
            </div>
