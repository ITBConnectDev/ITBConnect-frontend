    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        ...
        <div className="flex justify-center mt-3">
          <button className="bg-blue-primary text-white text-sm w-48 py-5 rounded-md">
            SHARE
          </button>
        </div>
        <div className="flex my-12 gap-6">
          <div className="flex flex-col gap-6 w-[380px]">
            <ul className="flex gap-3 flex-wrap">
              <Tag tag="Business Case" />
              <Tag tag="Programming" />
            </ul>
            <div className="p-12 border border-gray-400 rounded-3xl">
            ...
            <div className="p-12 border border-gray-400 rounded-3xl">
              ...
              <div className="mt-5">
                <h4 className="font-semibold text-base">18 September 2022</h4>
                <p className="text-xs text-gray-500 mt-1">Deadline Submisi</p>
              </div>
            </div>
            <div className="p-12 border border-gray-400 rounded-3xl">
              <h3 className="font-bold text-green-primary text-2xl">
              ...
              <ul className="mt-5 flex flex-col gap-6">
                {/* instagram */}
                <li className="font-semibold text-base flex items-center gap-3">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
          ...
          <div className="flex-1 p-12 border border-gray-400 rounded-3xl">
            <h3 className="font-bold text-green-primary text-2xl">
              Detail Acara
            </h3>
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: `<p>[ ACADEMY REGISTRATION IS NOW OPEN! ]</p>
<p>Masa registrasi Academy telah dibuka!</p>
<p>Academy kembali hadir untuk mengisi rangkaian acara COMPFEST serta didedikasikan untuk memajukan minat generasi masa depan dalam keterampilan IT yang diperlukan pada masa kini melalui empat bidang utama kami, yaitu :</p>
<ul>
<li>Data Science Academy (DSA)</li>
<li>Software Engineering Academy (SEA)</li>
<li>Startup Academy (SUA)</li>
<li>User Experience Academy (UXA)
Academy juga berusaha untuk memberikan kurikulum berkualitas untuk semua peserta.</li>
</ul>
<p>Periode registrasi dibuka pada tanggal:
15 Juni - 5 Juli 2022</p>
<p>Biaya untuk mengikuti Academy GRATIS dan bagi peserta yang mengikuti kegiatan sampai akhir akan mendapatkan e-certificate!</p>
<p>Untuk informasi lebih lanjut dapat dilihat pada poster di atas atau melalui link di bawah ini
<a href="https://compfest.link/academycf14">https://compfest.link/academycf14</a>
<a href="https://compfest.link/academycf14">https://compfest.link/academycf14</a>
<a href="https://compfest.link/academycf14">https://compfest.link/academycf14</a></p>
<p>Prepare yourself and learn more with Academy!</p>
<p>COMPFEST
@COMPFEST
compfest.id</p>
<p>#Academy</p>
<p>#EmbraceTheInevitable</p>
<p>#CF14</p>
`,
              }}
            ></div>
...
function Tag({ tag }: { tag: string }) {
  return (
    <li className="bg-green-primary text-white text-xs py-1 px-5 rounded-[5px]">
      {tag}
    </li>
  );
}
