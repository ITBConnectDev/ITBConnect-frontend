        ...
        <div className='w-full'>
            ...
            <div className='px-20 pt-20 lg:pt-32'>
                ...
                <div className='flex pt-2'>
                    ...
                    <Link href="/register"><h5 className='text-green-primary'> Sign up</h5></Link>
                </div>
                <div className="">
                <form className="pt-6">
                    <div className="mb-4">
                    ...
                    <div className="mb-1">
                        ...
                        <input className="appearance-none border border-2 rounded-lg w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <button className="inline-block align-baseline bg-blue-primary hover:bg-blue-700 text-white py-2 px-12 rounded focus:outline-none focus:shadow-outline border-blue-primary border-2" type="button">
                            Login
                        </button>
                    </div>
